    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacancyCourseMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VacancyCourseMappings_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VacancyCourseMappings_Vacancies_VacancyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enquiries_Courses_InterestedCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_Users_TakenByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeePlans_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FeePlans_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DemoClasses_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DemoClasses_Enquiries_EnquiryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FollowUps_Enquiries_EnquiryId",
                        column: x => x.EnquiryId,
                        principalTable: "Enquiries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Installments_FeePlans_FeePlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_FeePlans_FeePlanId",
                        column: x => x.FeePlanId,
                        principalTable: "FeePlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_BatchId",
                table: "AttendanceSessions",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_TakenByUserId",
                table: "AttendanceSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DemoClasses_BatchId",
                table: "DemoClasses",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_DemoClasses_EnquiryId",
                table: "DemoClasses",
                column: "EnquiryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enquiries_InstituteId",
                table: "Enquiries",
                column: "InstituteId");

            migrationBuilder.CreateIndex(
                name: "IX_Enquiries_InterestedCourseId",
                table: "Enquiries",
                column: "InterestedCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Enquiries_Mobile",
                table: "Enquiries",
                column: "Mobile");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeePlans_StudentId",
                table: "FeePlans",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_FollowUps_EnquiryId",
                table: "FollowUps",
                column: "EnquiryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Installments_FeePlanId",
                table: "Installments",
                column: "FeePlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vacancies_LastDate",
                table: "Vacancies",
                column: "LastDate");

            migrationBuilder.CreateIndex(
                name: "IX_VacancyCourseMappings_CourseId",
                table: "VacancyCourseMappings",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_VacancyCourseMappings_VacancyId",
                table: "VacancyCourseMappings",
                column: "VacancyId");
        }
